...
void CDAudio_Play (byte track, bool looping)
{
	...
	mciPlayParms.dwCallback = (DWORD) vid.Window;
...
void CDAudio_Pause (void)
{
	...
	mciGenericParms.dwCallback = (DWORD) vid.Window;
...
void CDAudio_Resume (void)
{
	...
	if ((dwReturn = mciSendCommand (wDeviceID, MCI_PLAY, MCI_TO | MCI_NOTIFY, (DWORD) (LPVOID) &mciPlayParms)) != 0)
	{
		Con_DPrintf ("CDAudio: MCI_PLAY failed (%i)\n", dwReturn);
		return;
	}
