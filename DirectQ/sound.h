...
// these are just the same bumped limits as fitzquake uses
// I suspect that the space being reserved for static sounds is waaaayyyyy too large here
// some day I'll probably push these into separate std::vector lists and use those instead...
#define	MAX_CHANNELS			512
#define	MAX_DYNAMIC_CHANNELS	128

#define FIRST_DYNAMIC_CHANNEL	NUM_AMBIENTS
#define FIRST_STATIC_CHANNEL	(MAX_DYNAMIC_CHANNELS + NUM_AMBIENTS)
